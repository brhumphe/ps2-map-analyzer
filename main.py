...
async def capturable_bases(world_id: int, zone_id: int, faction_id: int, request: Request):
    ...
    map_state_co = fetch_json(client, f"https://census.lithafalcon.cc/get/ps2/map_state",
    ...
    region_list_co = fetch_json(client, f"https://census.lithafalcon.cc/get/ps2/map_region",
                                params={"zone_id": zone_id, "c:censusJSON": False,
                                        "c:show": "map_region_id,facility_id,zone_id"})

    facility_links_co = fetch_json(client, f"https://census.lithafalcon.cc/get/ps2/facility_link",
                                   params={"zone_id": zone_id, "c:censusJSON": False})
